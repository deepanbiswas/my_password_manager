...
3. **Live TDI** — After `terraform apply`, run the iteration `verify.sh` from `infrastructure/terraform` as described in [auto_deploy_iterations.md](auto_deploy_iterations.md).
